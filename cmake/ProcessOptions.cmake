...
function( NEST_PROCESS_WITH_MPI )
  ...
  if ( with-mpi )
    ...
    if ( MPI_CXX_FOUND )
      ...
      set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS}   ${MPI_C_COMPILER_FLAGS}" PARENT_SCOPE )
      set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${MPI_CXX_COMPILER_FLAGS}" PARENT_SCOPE )
      ...
      set( MPI_C_COMPILER_FLAGS "${CMAKE_C_FLAGS} ${MPI_C_COMPILER_FLAGS}" PARENT_SCOPE )
      ...
      set( MPI_CXX_COMPILER_FLAGS "${CMAKE_CXX_FLAGS} ${MPI_CXX_COMPILER_FLAGS}" PARENT_SCOPE )
